...
public class HashUtil {
    ...
    /**
     * Hashes a URL string into a 64-bit number using MurmurHash3 (128-bit variant).
     * The lower 64 bits of the 128-bit hash are returned as a long.
     *
     * @param url the input string to hash
     * @return a 64-bit hash of the URL
     */
    public static long hashUrl128Bit(String url) {
        HashFunction hf = Hashing.murmur3_128();
        HashCode hc = hf.newHasher().putString(url, StandardCharsets.UTF_8).hash();
        return hc.asLong();
    }

   
    public static String hashUrl128BitHex(String url) {
