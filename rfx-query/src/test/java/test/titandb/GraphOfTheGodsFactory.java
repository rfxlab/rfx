...
public class GraphOfTheGodsFactory {
    ...
    public static void load(final TitanGraph graph) {
        ...
        mgmt.buildIndex("edges",Edge.class).addKey(reason).addKey(place).buildMixedIndex(INDEX_NAME);
    ...
    public static void main(String args[]) {
        String path = "/home/trieu/Programs/titan-0.5.4-hadoop2/conf/titan-berkeleydb-es.properties";
        TitanGraph g = TitanFactory.open(path);
        load(g);
        g.shutdown();
    }
}